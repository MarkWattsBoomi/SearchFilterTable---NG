...
var SFTCommonFunctions = class _SFTCommonFunctions {
  ...
  static async makeOutcomeButton(comp, outcome, suffix, objectData, dissabled) {
...
var SearchFilterTableRibbonSearch = class extends React16.Component {
  constructor(props) {
    super(props);
    this.previousFilter = "";
    this.deBounce = false;
  ...
  async generateButtons() {
    ...
    if (canExport === true) {
      this.rightButtons.push(
        /* @__PURE__ */ React16.createElement(
          ...
          !((_a = root.component.attributes) == null ? void 0 : _a.RibbonDisplay) || ((_b = root.component.attributes.RibbonDisplay) == null ? void 0 : _b.indexOf("text")) >= 0 ? /* @__PURE__ */ React16.createElement(
            "span",
            {
              className: "sft-ribbon-search-button-label"
            },
    ...
    if (root.rowMap.size > root.currentRowMap.size && canExport === true) {
      this.rightButtons.push(
        /* @__PURE__ */ React16.createElement(
          ...
          !((_c = root.component.attributes) == null ? void 0 : _c.RibbonDisplay) || ((_d = root.component.attributes.RibbonDisplay) == null ? void 0 : _d.indexOf("text")) >= 0 ? /* @__PURE__ */ React16.createElement(
            "span",
            {
              className: "sft-ribbon-search-button-label"
            },
      ...
      this.rightButtons.push(
        /* @__PURE__ */ React16.createElement(
          ...
          /* @__PURE__ */ React16.createElement(
            ...
            {
              key: "colpick",
              className: "glyphicon sft-ribbon-search-button-icon glyphicon-" + (((_f = root.component.attributes) == null ? void 0 : _f.InfoIcon) ? root.component.attributes.InfoIcon : "question-sign"),
              title: "Infornation"
            }
          ),
          !((_g = root.component.attributes) == null ? void 0 : _g.RibbonDisplay) || ((_h = root.component.attributes.RibbonDisplay) == null ? void 0 : _h.indexOf("text")) >= 0 ? /* @__PURE__ */ React16.createElement(
            "span",
            {
              className: "sft-ribbon-search-button-label"
            },
      ...
      this.rightButtons.push(
        /* @__PURE__ */ React16.createElement(
          ...
          /* @__PURE__ */ React16.createElement(
            ...
            {
              key: "colpick",
              className: "glyphicon sft-ribbon-search-button-icon glyphicon-" + (((_i = root.component.attributes) == null ? void 0 : _i.ColumnsIcon) ? root.component.attributes.ColumnsIcon : "option-vertical"),
              title: "Select columns"
            }
          ),
          !((_j = root.component.attributes) == null ? void 0 : _j.RibbonDisplay) || ((_k = root.component.attributes.RibbonDisplay) == null ? void 0 : _k.indexOf("text")) >= 0 ? /* @__PURE__ */ React16.createElement(
            "span",
            {
              className: "sft-ribbon-search-button-label"
            },
    ...
    if (root.selectedRowMap.size > 0 && canExport === true) {
      this.leftButtons.push(
        /* @__PURE__ */ React16.createElement(
          ...
          !((_l = root.component.attributes) == null ? void 0 : _l.RibbonDisplay) || ((_m = root.component.attributes.RibbonDisplay) == null ? void 0 : _m.indexOf("text")) >= 0 ? /* @__PURE__ */ React16.createElement(
            "span",
            {
              className: "sft-ribbon-search-button-label"
            },
    ...
    if (root.filters.isFiltered()) {
      this.clearFiltersButton = /* @__PURE__ */ React16.createElement(
        "div",
        {
...
var SearchFilterTableRow = class extends React17.Component {
  constructor(props) {
    super(props);
    ...
    if (col && col.developerName) {
      if (root.columnRules.has(col.developerName)) {
        ...
        if ((componentType == null ? void 0 : componentType.length) > 0) {
          ...
          result = React17.createElement(manywho.component.getByName(componentType), columnProps);
        } else {
          switch (contentType) {
            case eContentType.ContentDateTime:
              ...
              if ((dt instanceof Date && !isNaN(dt.getTime())) === true) {
                ...
                /* @__PURE__ */ React17.createElement("span", { className: "sft-table-cell-text" });
              }
              break;
            case eContentType.ContentString:
              switch (true) {
                ...
                case col.value.startsWith("https:"):
                  ...
                  if (this.isUrlImage(col.value)) {
                    inner = /* @__PURE__ */ React17.createElement(
                      "img",
                      {
                        src: col.value,
                  ...
                  switch (true) {
                    case mime.startsWith("audio/"):
                      result = /* @__PURE__ */ React17.createElement(
                        ...
                        /* @__PURE__ */ React17.createElement("source", { src: col.value, type: mime })
                      );
                      break;
                    ...
                    default:
                      ...
                      result = /* @__PURE__ */ React17.createElement("a", { href: col.value, target: "_blank", download: dnld }, "Download File");
                      break;
                  }
                  break;
  ...
  showContent(title, value) {
    ...
    const content = /* @__PURE__ */ React17.createElement(
      ...
      /* @__PURE__ */ React17.createElement("pre", null, /* @__PURE__ */ React17.createElement(
        "code",
        {
          style: {
            overflow: "visible",
  ...
  showXML(title, value) {
    ...
    const content = /* @__PURE__ */ React17.createElement(
      ...
      /* @__PURE__ */ React17.createElement("pre", null, /* @__PURE__ */ React17.createElement("code", null, value))
    );
    const root = this.props.root;
    root.messageBox.showDialog(
      null,
...
var FCMContextMenu = class extends React18.Component {
  constructor(props) {
    super(props);
    this.displayStyle = {};
    this.menuItems = [];
  ...
  render() {
    return React18.createElement(
      ...
      React18.createElement("ul", { className: "fcmcm-list" }, this.menuItems)
    );
  }
};
